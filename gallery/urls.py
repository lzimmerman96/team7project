...
urlpatterns = [
    ...
    path('collection_home',views.collection_home, name='collection_home'),
    path('collection_list', views.collection_list, name='collection_list'),
    path('collection_artistuser', views.collection_artistuser, name='collection_artistuser'),
    path('collection_artistuser2', views.collection_artistuser2, name='collection_artistuser2'),
